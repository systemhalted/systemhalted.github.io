...
That is where rights become newly urgent.

## Examples

The paper discusses rights such as the right to public anonymity, the right to be forgotten, and the right to disconnect.
...
In each case, the ethical question is not only whether the technology works. It is whether the technology has created a new imbalance that requires a corresponding duty.
...
Those questions are where the theory has to become governance.
