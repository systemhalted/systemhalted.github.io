...
Search on this site is a client-side overlay. It runs entirely in your browser against an index built from all published writing, so there are no server round-trips once the page has loaded.
...
<table>
  ...
  <tbody>
    ...
    <tr><td><kbd>g</kbd> <kbd>n</kbd></td><td>Go to Notes</td></tr>
