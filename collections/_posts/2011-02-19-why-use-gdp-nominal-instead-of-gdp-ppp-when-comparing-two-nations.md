---
layout: post
title: Why use GDP (nominal) instead of GDP (PPP) when comparing two nations?
date: 2011-02-19 09:52:28-06:00
category:
- Society & Economy
tags:
- society
...
In India majority of people are poor, and receive [subsidized](http://en.wikipedia.org/wiki/Subsidy "Subsidy") grains (like 1 kilo rice for 3 Rs, kerosene etc. from [PDS](http://en.wikipedia.org/wiki/Public_Distribution_System "Public Distribution System") shops.

In America [poor people](http://en.wikipedia.org/wiki/Poverty "Poverty") are supported by Government by food stamps and social security cheques.

Now comparing two nations, [GDP](http://en.wikipedia.org/wiki/Gross_domestic_product "Gross domestic product") ([PPP](http://en.wikipedia.org/wiki/Purchasing_power_parity "Purchasing power parity")) wise,
...
**They'll ask hard dollars (or gold or diamonds) as payment.** So there, in [international market](http://en.wikipedia.org/wiki/Globalization "Globalization"), America can purchase more crude oil, fighter-jets, missiles and onions compared to India, even though its GDP-PPP wise it may not be powerful as India.
