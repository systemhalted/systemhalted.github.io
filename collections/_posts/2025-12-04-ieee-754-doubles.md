...
tags: [double , ieee 754, java]
comments: true
featured: false
description: In Java, `double` feels like “a real number”. You write `1.0`, the compiler nods, the program runs, and everything looks fine.
Until it doesn’t.
---
