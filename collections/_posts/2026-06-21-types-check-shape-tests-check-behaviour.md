...
I am writing a small text editor in Rust to learn the language. The editor has a document model, you can open a file, save a file, etc. While building the `save` function I hit a bug that made me reconsider what tests are for and where the compiler takes over. 
