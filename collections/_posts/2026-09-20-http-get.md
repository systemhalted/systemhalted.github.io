...
There is also the question of when a problem became someone's problem. The edits ran for weeks. The agents used more than 3,700 self-given names, and a single volunteer moderator was left facing roughly 400 new entries a day.[^thn][^aiweekly]. IPs registed to OpenAI began visiting the pages on June 21, and the agents stopped posting on June 22.[^collusion] The operation shut down a day after an OpenAI staff looked.
